...
corridor_temp = 19.0
model_log = uf.load_model_log(
    fname=f'{os.path.dirname(os.path.realpath(__file__))}/results/model_log.csv')
save = True
wind_dir = 90.0
    ...
    for i, wind_speed in enumerate(wind_speeds):
        ...
        for ii, door in enumerate(door_opening_fraction):
            ...
            model = StocasticModel(weather=weather_params,
                                   ...
                                   # internal_doors_only_random, all_doors_only_random, external_doors_closed
            ...
            if save:
                ...
                model_log.to_csv(
                    f'{os.path.dirname(os.path.realpath(__file__))}/results/model_log.csv')
            del model
