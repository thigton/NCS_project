...
def state_dot_AS_2(t, state, TG, RH, s_comp, lambda_v, integrate, **kwargs):
...
if __name__ == '__main__':
    ...
    for RH in relative_humidity:
        ...
        for droplet in droplet_sizes:
            ...
            while True:
                count += 1
                soln = solve_ivp(fun=lambda t, y : state_dot_AS_2(t, y, TG, RH, s_comp, lambda_v, True),# reduced=reduced_model),
                                 t_span=(t_0, t_end),
                                 t_eval=teval,
                                 y0=state_0,
                                 method='BDF',
