...
if __name__ == '__main__':
    ...
    open_steady_state = np.linalg.solve(ventilation_rates_open, -quanta*I0)
    closed_steady_state = np.linalg.solve(ventilation_rates_open, -quanta*I1)
    ...
    ax[0].step(t_ss, [0, open_steady_state[second_room_idx], closed_steady_state[second_room_idx]],
